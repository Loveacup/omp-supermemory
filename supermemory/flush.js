...
// src/services/transcript.ts
var SESSIONS_DIR = (0, import_node_path4.join)((0, import_node_os5.homedir)(), ".omp", "agent", "sessions");
function findTranscriptPath(sessionId) {
  if (!(0, import_node_fs4.existsSync)(SESSIONS_DIR)) {
    return null;
  }
  try {
    const subdirs = (0, import_node_fs4.readdirSync)(SESSIONS_DIR);
    for (const subdir of subdirs) {
      const fullPath = (0, import_node_path4.join)(SESSIONS_DIR, subdir);
...
var TRACKER_DIR = (0, import_node_path5.join)((0, import_node_os6.homedir)(), ".omp-supermemory", "trackers");
